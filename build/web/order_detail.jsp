                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    <c:forEach var="o" items="${odl}">
                                        <tr class="table_row">
                                            ...
                                            <c:set var="itemPrice" value="${o.getPrice() * o.getQuantity()}" />
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 p-b-50">
                        ...
                        <div class="p-t-27">
                            <a href="#" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="Facebook" aria-label="Facebook">
