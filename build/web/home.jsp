...
<%-- 
    Document   : home
    Created on : Aug 13, 2023, 6:14:32 PM
    Author     : chi
--%>
                ...
                <div class="row">
                    <c:forEach var="o" items="${listC}">
                        ...
                        <div class="block1 wrap-pic-w">
                            <img src="${o.image}" style="height: 15rem;" alt="IMG-BANNER">
                            <a href="ProductList?categoryId=${o.id}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                    ...
                    <c:forEach var="o" items="${listP}">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <a href="ProductDetails?pid=${o.id}" > <img src="${o.img}" alt="IMG-PRODUCT"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 p-b-50">
                        ...
                        <p class="stext-107 cl7 size-201">
                            Any questions? Let us know in store at  27 W 8th St, New York, NY 10011, USA or call us on +1 212-228-5166
                        </p>
                        <div class="p-t-27">
