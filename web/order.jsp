        ...
        <form action="Checkout" method="POST" class="bg0 p-t-75 p-b-85" style="margin-top: 5rem;">
            <div class="container">
                ...
                <div class="row">
                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    <c:forEach var="o" items="${ol}">
                                        <tr class="table_row">
                                            ...
                                            <td class="column-4">${o.notes}</td>
                                            <td class="column-6">
                                                <div class="column-5">
                                                    <a href="OrderDetails?oid=${o.id}"style="color: blue;">Detail</a>
                                                </div>
                                            </td>
                                            <c:set var="totalSpend" value="${totalSpend + o.total}" />
                                            <c:set var="totalOrder" value="${totalOrder + 1}" />
                                        </tr>
                                    </c:forEach>
                    ...
                    <div class="form-outline mb-4"> total order: 
                    <span class="mtext-110 cl2">
                        ${totalOrder}
                    </span>
                </div>
                    <div class="form-outline mb-4"> total spend: 
                    <span class="mtext-110 cl2">
                        $${totalSpend}
                    </span>
                </div>
